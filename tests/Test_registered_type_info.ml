...
let get_enum_info namespace enum_name =
  ...
  | Some base_info -> (
      ...
      | Enum ->
          let info = Enum_info.from_baseinfo base_info in
          Some info
      | _ -> None)
...
let get_struct_info namespace struct_name =
  ...
  | Some base_info -> (
      match Base_info.get_type base_info with
      | Struct ->
          let info = Struct_info.from_baseinfo base_info in
          Some info
      | _ -> None)
...
let get_union_info namespace union_name =
  ...
  | Some base_info -> (
      match Base_info.get_type base_info with
      | Union ->
          let info = Union_info.from_baseinfo base_info in
          Some info
      | _ -> None)
...
let tests =
  ...
  >::: [
         "Registered_type_info get type name from enum"
         >:: test_get_type_name_from_enum;
         "Registered_type_info get type name from interface"
         >:: test_get_type_name_from_interface;
         "Registered_type_info get type name from object"
         >:: test_get_type_name_from_object;
         "Registered_type_info get type name from struct"
         >:: test_get_type_name_from_struct;
         ...
         "Registered_type_info get type init from union"
         >:: test_get_type_init_from_union;
         "Registered_type_info get type init from enum"
         >:: test_get_type_init_from_enum;
       ]
