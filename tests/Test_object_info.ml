...
let test_from_baseinfo _ =
  ...
  | Some base_info ->
      assert_equal_boolean true
        (match Base_info.get_type base_info with Object -> true | _ -> false)
...
let test_gtk_window_get_interface _ =
  object_test (fun info ->
      ...
      | None -> assert_equal_string "It should have" " a name"
      | Some interface_name ->
          assert_equal_string "ImplementorIface" interface_name)
...
let test_gtk_window_find_vfunc_using_interfaces _ =
  object_test (fun info ->
      ...
      let vfunc, implementor =
        Object_info.find_vfunc_using_interfaces info vfunc_name
      in
      let _ =
        match implementor with
...
let test_gtk_window_find_method_using_interfaces _ =
  object_test (fun info ->
      ...
      let meth, implementor =
        Object_info.find_method_using_interfaces info method_name
      in
      let _ =
        match implementor with
        | None -> assert_equal true true
...
let test_gtk_window_get_set_value_function _ =
  object_test (fun info ->
      ...
      | None -> assert_equal true true
      | Some _ ->
          assert_equal_string "It should not " "have any set value function")
...
let tests =
  ...
  >::: [
         ...
         "Object_info GtkWindow get fundamental"
         >:: test_gtk_window_get_fundamental;
         ...
         "Object_info GtkWindow get n constants"
         >:: test_gtk_window_get_n_constants;
         "Object_info GtkWindow get n fields" >:: test_gtk_window_get_n_fields;
         "Object_info GtkWindow get n interfaces"
         ...
         "Object_info GtkWindow get n properties"
         >:: test_gtk_window_get_n_properties;
         ...
         "Object_info GtkWindow find vfunc using interfaces"
         >:: test_gtk_window_find_vfunc_using_interfaces;
         "Object_info GtkWindow get class struct"
         >:: test_gtk_window_get_class_struct;
         "Object_info GtkWindow get property" >:: test_gtk_window_get_property;
         "Object_info GtkWindow find method using interfaces"
         >:: test_gtk_window_find_method_using_interfaces;
         "Object_info GtkWindow get ref function"
         >:: test_gtk_window_get_ref_function;
         "Object_info GtkWindow get unref function"
         >:: test_gtk_window_get_unref_function;
         "Object_info GtkWindow get set value function"
         >:: test_gtk_window_get_set_value_function;
         "Object_info GtkWindow get get value function"
         >:: test_gtk_window_get_get_value_function;
       ]
