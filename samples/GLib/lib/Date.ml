...
let new_dmy =
foreign "g_date_new_dmy" (ptr t_typ @-> uint8_t @-> Core.date_month @-> uint16_t @-> returning (ptr t_typ))
let new_julian =
...
let get_month =
foreign "g_date_get_month" (ptr t_typ @-> returning (Core.date_month))
let get_sunday_week_of_year =
foreign "g_date_get_sunday_week_of_year" (ptr t_typ @-> returning (uint32_t))
let get_weekday =
foreign "g_date_get_weekday" (ptr t_typ @-> returning (Core.date_weekday))
let get_year =
...
let set_dmy =
foreign "g_date_set_dmy" (ptr t_typ @-> uint8_t @-> Core.date_month @-> uint16_t @-> returning (void))
let set_julian =
foreign "g_date_set_julian" (ptr t_typ @-> uint32_t @-> returning (void))
let set_month =
foreign "g_date_set_month" (ptr t_typ @-> Core.date_month @-> returning (void))
let set_parse =
...
foreign "g_date_get_days_in_month" (ptr t_typ @-> Core.date_month @-> uint16_t @-> returning (uint8_t))
...
let valid_dmy =
foreign "g_date_valid_dmy" (ptr t_typ @-> uint8_t @-> Core.date_month @-> uint16_t @-> returning (bool))
let valid_julian =
foreign "g_date_valid_julian" (ptr t_typ @-> uint32_t @-> returning (bool))
let valid_month =
foreign "g_date_valid_month" (ptr t_typ @-> Core.date_month @-> returning (bool))
let valid_weekday =
foreign "g_date_valid_weekday" (ptr t_typ @-> Core.date_weekday @-> returning (bool))
let valid_year =
