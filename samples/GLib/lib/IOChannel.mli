...
val f_funcs: ( ptr, t structure) field
val f_encoding: (string ptr, t structure) field
val f_read_cd: ( ptr, t structure) field
val f_write_cd: ( ptr, t structure) field
...
val f_read_buf: ( ptr, t structure) field
val f_encoded_read_buf: ( ptr, t structure) field
val f_write_buf: ( ptr, t structure) field
