...
let value = get_added_raw arg1 arg2 (Some err_ptr_ptr)
in
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = get_is_private_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = get_modified_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = get_visited_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = has_application_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = has_group_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = load_from_data_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = load_from_data_dirs_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = load_from_file_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = move_item_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = remove_application_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = remove_group_raw arg1 arg2 arg3 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = remove_item_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = set_app_info_raw arg1 arg2 arg3 arg4 arg5 arg6 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
...
in
let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
let value = to_file_raw arg1 arg2 (Some err_ptr_ptr)
in
match (!@ err_ptr_ptr) with
| None -> Ok value
| Some _ -> Error (!@ err_ptr_ptr)
