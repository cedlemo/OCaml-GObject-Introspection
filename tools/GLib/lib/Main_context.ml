...
let _new =
foreign "g_main_context_new" (ptr t_typ @-> returning (ptr (* interface *) t_typ))

let acquire =
foreign "g_main_context_acquire" (ptr t_typ @-> returning (bool))

let add_poll =
foreign "g_main_context_add_poll" (ptr t_typ @-> ptr (* interface *) Poll_fd.t_typ @-> int32_t @-> returning (void))
...
foreign "g_main_context_find_source_by_funcs_user_data" (ptr t_typ @-> ptr (* interface *) Source_funcs.t_typ @-> ptr_opt void @-> returning (ptr (* interface *) Source.t_typ))

let find_source_by_id =
foreign "g_main_context_find_source_by_id" (ptr t_typ @-> uint32_t @-> returning (ptr (* interface *) Source.t_typ))

let find_source_by_user_data =
foreign "g_main_context_find_source_by_user_data" (ptr t_typ @-> ptr_opt void @-> returning (ptr (* interface *) Source.t_typ))
...
let ref =
foreign "g_main_context_ref" (ptr t_typ @-> returning (ptr (* interface *) t_typ))

let release =
foreign "g_main_context_release" (ptr t_typ @-> returning (void))

let remove_poll =
foreign "g_main_context_remove_poll" (ptr t_typ @-> ptr (* interface *) Poll_fd.t_typ @-> returning (void))
...
let default =
foreign "g_main_context_default" (ptr t_typ @-> returning (ptr (* interface *) t_typ))

let get_thread_default =
foreign "g_main_context_get_thread_default" (ptr t_typ @-> returning (ptr (* interface *) t_typ))

let ref_thread_default =
foreign "g_main_context_ref_thread_default" (ptr t_typ @-> returning (ptr (* interface *) t_typ))
