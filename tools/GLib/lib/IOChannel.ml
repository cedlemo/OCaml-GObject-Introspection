...
let new_file arg1 arg2 =
  ...
  let value = new_file_raw arg1 arg2 (Some err_ptr_ptr) in
...
let flush arg1 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = flush_raw arg1 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let read_line_string arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = read_line_string_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let seek_position arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = seek_position_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let set_encoding arg1 arg2 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = set_encoding_raw arg1 arg2 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let set_flags arg1 arg2 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = set_flags_raw arg1 arg2 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let shutdown arg1 arg2 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = shutdown_raw arg1 arg2 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
