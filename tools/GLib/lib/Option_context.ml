...
let add_group =
foreign "g_option_context_add_group" (ptr t_typ @-> ptr (* interface *) Option_group.t_typ @-> returning (void))

let add_main_entries =
foreign "g_option_context_add_main_entries" (ptr t_typ @-> ptr (* interface *) Option_entry.t_typ @-> string_opt @-> returning (void))
...
let get_help =
foreign "g_option_context_get_help" (ptr t_typ @-> bool @-> ptr_opt (* interface *) Option_group.t_typ @-> returning (string))
...
let get_main_group =
foreign "g_option_context_get_main_group" (ptr t_typ @-> returning (ptr (* interface *) Option_group.t_typ))
...
let set_main_group =
foreign "g_option_context_set_main_group" (ptr t_typ @-> ptr (* interface *) Option_group.t_typ @-> returning (void))
