...
let _new =
foreign "g_date_new" (ptr t_typ @-> returning (ptr (* interface *) t_typ))

let new_dmy =
foreign "g_date_new_dmy" (ptr t_typ @-> uint8_t @-> (* interface *) Date_month.t_view @-> uint16_t @-> returning (ptr (* interface *) t_typ))

let new_julian =
foreign "g_date_new_julian" (ptr t_typ @-> uint32_t @-> returning (ptr (* interface *) t_typ))
...
let clamp =
foreign "g_date_clamp" (ptr t_typ @-> ptr (* interface *) t_typ @-> ptr (* interface *) t_typ @-> returning (void))

let clear =
foreign "g_date_clear" (ptr t_typ @-> uint32_t @-> returning (void))

let compare =
foreign "g_date_compare" (ptr t_typ @-> ptr (* interface *) t_typ @-> returning (int32_t))

let days_between =
foreign "g_date_days_between" (ptr t_typ @-> ptr (* interface *) t_typ @-> returning (int32_t))
...
let get_month =
foreign "g_date_get_month" (ptr t_typ @-> returning ((* interface *) Date_month.t_view))

let get_sunday_week_of_year =
foreign "g_date_get_sunday_week_of_year" (ptr t_typ @-> returning (uint32_t))

let get_weekday =
foreign "g_date_get_weekday" (ptr t_typ @-> returning ((* interface *) Date_weekday.t_view))
...
let order =
foreign "g_date_order" (ptr t_typ @-> ptr (* interface *) t_typ @-> returning (void))

let set_day =
foreign "g_date_set_day" (ptr t_typ @-> uint8_t @-> returning (void))

let set_dmy =
foreign "g_date_set_dmy" (ptr t_typ @-> uint8_t @-> (* interface *) Date_month.t_view @-> uint16_t @-> returning (void))

let set_julian =
foreign "g_date_set_julian" (ptr t_typ @-> uint32_t @-> returning (void))

let set_month =
foreign "g_date_set_month" (ptr t_typ @-> (* interface *) Date_month.t_view @-> returning (void))
...
let set_time_val =
foreign "g_date_set_time_val" (ptr t_typ @-> ptr (* interface *) Time_val.t_typ @-> returning (void))
...
foreign "g_date_get_days_in_month" (ptr t_typ @-> (* interface *) Date_month.t_view @-> uint16_t @-> returning (uint8_t))
...
let strftime =
foreign "g_date_strftime" (ptr t_typ @-> string @-> uint64_t @-> string @-> ptr (* interface *) t_typ @-> returning (uint64_t))

let valid_day =
foreign "g_date_valid_day" (ptr t_typ @-> uint8_t @-> returning (bool))

let valid_dmy =
foreign "g_date_valid_dmy" (ptr t_typ @-> uint8_t @-> (* interface *) Date_month.t_view @-> uint16_t @-> returning (bool))

let valid_julian =
foreign "g_date_valid_julian" (ptr t_typ @-> uint32_t @-> returning (bool))

let valid_month =
foreign "g_date_valid_month" (ptr t_typ @-> (* interface *) Date_month.t_view @-> returning (bool))

let valid_weekday =
foreign "g_date_valid_weekday" (ptr t_typ @-> (* interface *) Date_weekday.t_view @-> returning (bool))
