...
let get_boolean arg1 arg2 arg3 =
  ...
  let value = get_boolean_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
...
let get_comment arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_comment_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_double arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_double_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_int64 arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_int64_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_integer arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_integer_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_locale_string arg1 arg2 arg3 arg4 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_locale_string_raw arg1 arg2 arg3 arg4 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_string arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_string_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_uint64 arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_uint64_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let get_value arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = get_value_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let load_from_data arg1 arg2 arg3 arg4 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = load_from_data_raw arg1 arg2 arg3 arg4 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let load_from_file arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = load_from_file_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let remove_comment arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = remove_comment_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let remove_group arg1 arg2 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = remove_group_raw arg1 arg2 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let remove_key arg1 arg2 arg3 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = remove_key_raw arg1 arg2 arg3 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let save_to_file arg1 arg2 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = save_to_file_raw arg1 arg2 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
...
let set_comment arg1 arg2 arg3 arg4 =
  ...
  in
  let err_ptr_ptr = allocate (ptr_opt Error.t_typ) None in
  let value = set_comment_raw arg1 arg2 arg3 arg4 (Some err_ptr_ptr) in
  match (!@ err_ptr_ptr) with
   | None -> Ok value
   | Some _ -> let err_ptr = !@ err_ptr_ptr in
     let _ = Gc.finalise (function | Some e -> Error.free e | None -> () ) err_ptr in
