...
let get_flags =
  foreign "g_field_info_get_flags" (ptr fieldinfo @-> returning flags_list)

let get_offset =
  foreign "g_field_info_get_offset" (ptr fieldinfo @-> returning int)

let get_size = foreign "g_field_info_get_size" (ptr fieldinfo @-> returning int)
...
let cast_to_baseinfo info = coerce (ptr fieldinfo) (ptr Base_info.baseinfo) info
