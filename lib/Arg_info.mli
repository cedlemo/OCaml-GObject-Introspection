...
val get_direction : t structure ptr -> Bindings.Arg_info.direction
(** Obtain the direction of the argument. Check GIDirection for possible
    direction values.*)

val get_closure : t structure ptr -> int
...
val may_be_null : t structure ptr -> bool
...
val is_caller_allocates : t structure ptr -> bool
