...
val get_n_values : t structure ptr -> int
...
val get_value : t structure ptr -> int -> Value_info.t structure ptr option
(** Obtain a value for this enumeration. *)

val get_error_domain : t structure ptr -> string option
(** Obtain the string form of the quark for the error domain associated with
    this enum, if any. *)

val get_storage_type : t structure ptr -> Bindings.Types.tag
